...
const appCss = "/assets/styles-D1Jr8aZI.css";
...
function SiteNav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "fixed top-0 left-0 right-0 z-50 px-6 md:px-10 py-6 flex justify-between items-center mix-blend-difference text-white", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "font-display text-2xl md:text-3xl tracking-tighter leading-none", children: [
        "ALPACA ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "/" }),
        " STUDIO"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex gap-8 font-mono text-[11px] uppercase tracking-widest", children: links.slice(1).map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: l.to,
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-[60] bg-foreground text-background flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center px-6 py-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display text-2xl tracking-tighter", children: [
          "ALPACA ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "/" }),
          " STUDIO"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { "aria-label": "Cerrar", onClick: () => setOpen(false), children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "size-6" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex flex-col justify-center px-6 gap-2", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: l.to,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-6 font-mono text-[10px] uppercase tracking-widest opacity-60", children: "alpacastudiomkt@gmail.com" })
    ] })
  ] });
}
function SiteFooter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-primary text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 md:px-10 py-16 md:py-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row justify-between items-start md:items-end gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs uppercase tracking-widest mb-4 opacity-70", children: "¿Tienes una marca para mover el mundo?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-6xl md:text-9xl leading-[0.85] tracking-tighter", children: "Hablemos." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs uppercase tracking-widest mt-6 opacity-70", children: "Torreón · Monterrey · Durango" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          ...
          children: "alpacastudiomkt@gmail.com"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-20 pt-8 border-t border-foreground/10 grid grid-cols-2 md:grid-cols-4 gap-8 font-mono text-[11px] uppercase tracking-widest", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "opacity-50 mb-3", children: "Estudio" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/estudio", className: "hover:underline", children: "Sobre nosotros" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/proyectos", className: "hover:underline", children: "Proyectos" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "opacity-50 mb-3", children: "Servicios" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/servicios", hash: "digital", className: "hover:underline", children: "Social & Marketing" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/servicios", hash: "interior", className: "hover:underline", children: "Interiorismo" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/servicios", hash: "btl", className: "hover:underline", children: "BTL & Eventos" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "opacity-50 mb-3", children: "Social" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://instagram.com", target: "_blank", rel: "noreferrer", className: "hover:underline", children: "Instagram" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://behance.net", target: "_blank", rel: "noreferrer", className: "hover:underline", children: "Behance" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://linkedin.com", target: "_blank", rel: "noreferrer", className: "hover:underline", children: "LinkedIn" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "opacity-50 mb-3", children: "Contacto" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contacto", className: "hover:underline", children: "Cotizar proyecto" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "+52 81 2298 7554" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-16 flex flex-col md:flex-row justify-between gap-4 font-mono text-[10px] uppercase tracking-widest opacity-60", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Alpaca Creative Studio"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Hecho con ⚡ en México" })
    ] })
  ] }) });
}
...
const Route$5 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Alpaca — Estudio Creativo de Diseño, Marketing e Interiorismo" },
      { name: "description", content: "Alpaca es un estudio creativo mexicano. Social media, branding, interiorismo y experiencias BTL para marcas que quieren mover el mundo." },
      { name: "author", content: "Alpaca Creative Studio" },
      { property: "og:title", content: "Alpaca — Estudio Creativo de Diseño, Marketing e Interiorismo" },
      { property: "og:description", content: "Alpaca es un estudio creativo mexicano. Social media, branding, interiorismo y experiencias BTL para marcas que quieren mover el mundo." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Alpaca — Estudio Creativo de Diseño, Marketing e Interiorismo" },
      { name: "twitter:description", content: "Alpaca es un estudio creativo mexicano. Social media, branding, interiorismo y experiencias BTL para marcas que quieren mover el mundo." },
...
const $$splitComponentImporter$4 = () => import("./servicios-u3LR7a1S.js");
const Route$4 = createFileRoute("/servicios")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Social media y marketing, diseño de interiores, experiencias BTL, branding, sitios web y producción creativa."
    }, {
      property: "og:title",
      content: "Servicios — Alpaca"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./proyectos-ChSTNF5n.js");
const Route$3 = createFileRoute("/proyectos")({
  head: () => ({
    meta: [{
      title: "Proyectos — Alpaca Creative Studio"
    }, {
      name: "description",
      content: "Selección de proyectos: branding, interiorismo, social media y activaciones BTL."
    }, {
      property: "og:title",
      content: "Proyectos — Alpaca"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./estudio-DdywKgxw.js");
const Route$2 = createFileRoute("/estudio")({
  head: () => ({
    meta: [{
      title: "Estudio — Alpaca Creative Studio"
    }, {
      name: "description",
      content: "Conoce a Alpaca: un estudio creativo mexicano que combina diseño, estrategia y producción."
    }, {
      property: "og:title",
      content: "Estudio — Alpaca"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./contacto-CnbG5XuB.js");
const Route$1 = createFileRoute("/contacto")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Cuéntanos sobre tu proyecto. Diseño digital, interiorismo y BTL desde Torreón, Monterrey y Durango."
    }, {
      property: "og:title",
      content: "Contacto — Alpaca"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-wEQSUpo7.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Boost your brand. Diseño digital, branding, interiorismo y experiencias BTL desde México."
    }]
  }),
...
const ProyectosRoute = Route$3.update({
  id: "/proyectos",
  path: "/proyectos",
  getParentRoute: () => Route$5
});
const EstudioRoute = Route$2.update({
  id: "/estudio",
  path: "/estudio",
  getParentRoute: () => Route$5
});
